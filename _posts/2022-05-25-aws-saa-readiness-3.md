...
[aws-privaite-instance-outbound-traffic](/assets/images/aws-privaite-instance-outbound-traffic.png)
...
S3에 저장된 데이터는 기본적으로 프라잆이며 액세스하려면 AWS 자격 증명이 필요하고 HTTP 또는 HTTPS를 통해 액세스할 수 있다.  
